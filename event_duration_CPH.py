...
##########################################################################################################################
# Event - Cox Proportional Harazards Model
##########################################################################################################################
...
remove = [ 'repose', 'caldera', 'dome', 'shield', 'complex', 'compound', 'continental', 'ctcrust1', 'volume', 'eruptionssince1960', 'avgrepose', 'summit_crater' ]
df.drop( columns=remove, inplace=True )
