...
# Standardize
cols_standardize = [ 'elevation', 'volume', 'vei','repose', 'eruptionssince1960', 'h_bw', 'ellip' ]
cols_leave = ['dome', 'complex', 'lava_cone', 'subduction', 'continental', 'mafic', 'intermediate', 'felsic', 'summit_crater' ]
